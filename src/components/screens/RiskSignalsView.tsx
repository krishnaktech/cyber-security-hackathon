...
export const RiskSignalsView: React.FC<RiskSignalsViewProps> = ({
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto text-[#1E1B4B]">
      {/* Header */}
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.04)] overflow-hidden">
        <div className="px-4 sm:px-5 py-3.5 border-b border-[#E2E8F0] bg-[#F5F6FA] flex items-center justify-between">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs table-fixed">
            <thead className="bg-[#F5F6FA] text-[10px] font-bold text-[#383278] uppercase tracking-wider border-b border-[#E2E8F0]">
              <tr>
                <th className="w-[22%] px-3.5 py-3 text-left">Entity</th>
                <th className="w-[9%] px-2 py-3 text-center">Type</th>
                <th className="w-[15%] px-2 py-3 text-center">Risk Score</th>
                <th className="w-[9%] px-2 py-3 text-center">Level</th>
                <th className="w-[31%] px-3 py-3 text-left">Triggered Signals</th>
                <th className="w-[9%] px-2 py-3 text-center">Evidence</th>
                <th className="w-[5%] px-2 py-3 text-center">Inspect</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#E2E8F0] text-[#1E1B4B]">
              {scoredEntities.map(entity => (
                ...
                >
                  <td className="px-3.5 py-3 align-middle text-left min-w-0">
                  ...
                  <td className="px-2 py-3 align-middle text-center">
                    <div className="flex items-center justify-center gap-1.5">
                      <div className="w-12 sm:w-14 bg-[#E2E8F0] rounded-full h-1.5 overflow-hidden shrink-0">
                        <div
                      ...
                      <span className="font-mono font-bold text-xs text-[#1E1B4B] shrink-0">
                        {entity.riskScore}
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="px-3 py-3 align-middle text-left min-w-0">
                    <div className="space-y-0.5 min-w-0">
                      {entity.signals.slice(0, 2).map(sig => (
                        <div
                          key={sig.id}
                          className="text-[11px] text-[#1E1B4B] flex items-center gap-1 truncate font-medium"
                          title={sig.label}
                        >
                  ...
                  <td className="px-2 py-3 align-middle text-center font-mono text-[11px] text-[#64748B] whitespace-nowrap">
